<%-- 
    Document   : exporDeposito
    Created on : 18/07/2016, 09:23:53 PM
    Author     : trabajo
--%>
...
<%@page import="java.sql.ResultSet"%>
    ...
    <body>
        ...
        <table class="jtabla" border="1" cellspacing="0">
            ...
            String consulta="SELECT Folio,Fecha,Apellidos,Nombre,Monto,Curso,Modulos,Nom_Instructor,Clave_del_Curso_o_Diplomado,Deposito_Referencia,Correo,Telefono,Comentario FROM recibos where  Deposito_Referencia like '"+foltro+"%'";
       ...
       while (rs.next()){
        ...
        <br> 
        <a  href="filtrodeposito.jsp">Regresar</a> 
    </body>
</html>
