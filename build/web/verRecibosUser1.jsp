<%-- 
    Document   : verRecibosUser1
    Created on : 15/05/2016, 08:42:36 PM
    Author     : LEONARDO
--%>
...
<%@page import="java.sql.ResultSet"%>
    ...
    <body>
        ...
        <table class="jtabla" border="1" cellspacing="0">
            ...
            String consulta="SELECT Folio,Fecha,Apellidos,Nombre,Monto,Curso,Modulos,Nom_Instructor,Clave_del_Curso_o_Diplomado,Deposito_Referencia,Correo,Telefono,Comentario FROM recibos where  Curso ='"+foltro+"'";
