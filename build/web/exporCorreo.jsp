<%-- 
    Document   : exporCorreo
    Created on : 19/07/2016, 11:27:44 AM
    Author     : trabajo
--%>
...
<%@page import="java.sql.ResultSet"%>
    ...
    <body>
        ...
        <table class="jtabla" border="1" cellspacing="0">
            ...
            String consulta="SELECT Folio,Fecha,Apellidos,Nombre,Monto,Curso,Modulos,Nom_Instructor,Clave_del_Curso_o_Diplomado,Deposito_Referencia,Correo,Telefono,Comentario FROM recibos where  Correo like '"+foltro+"%'";
       ...
       while (rs.next()){
        ...
        <br> 
        <a  href="filtrocorreo.jsp">Regresar</a> 
    </body>
</html>
