<%-- 
    Document   : instructorexcel
    Created on : 19/07/2016, 01:27:16 PM
    Author     : trabajo
--%>
...
<html>
    ...
    <body>
        ...
        <table  class=" jtabla" border="1" cellspacing="0">
            ...
            response.setHeader("Content-Disposition", "attachment;filename=\"RECIBOSPORINSTRUCTOR.xls\"");
            conexion co=new conexion();
            co.getconexion();
            PreparedStatement pst=null;
            ResultSet rs=null;
       
            String consulta="SELECT Folio,Fecha,Apellidos,Nombre,Monto,Curso,Modulos,Nom_Instructor,Clave_del_Curso_o_Diplomado,Deposito_Referencia,Correo,Telefono,Comentario FROM recibos where  Nom_Instructor like '"+foltro+"%'";
